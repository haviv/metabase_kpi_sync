...
class DatabaseConnection:
    ...
    def update_history_snapshots(self):
        ...
        metrics = [
            ...
            ('open_p1_bugs_with_customer_issues_cn', "SELECT COUNT(*) FROM bugs WHERE state NOT IN ('Done', 'Not reproduced', 'QA Completed', 'Removed') AND severity = '1' AND customer_name IS NOT NULL AND created_date >= '2025-12-01'"),
            ('p1_p2_bugs_with_customer_issues_cn', "SELECT COUNT(*) FROM bugs WHERE state NOT IN ('Done', 'Not reproduced', 'QA Completed', 'Removed') AND severity IN ('1','2') AND customer_name IS NOT NULL AND created_date >= '2025-12-01'")
        ]
